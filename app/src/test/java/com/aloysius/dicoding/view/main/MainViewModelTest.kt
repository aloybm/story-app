...
import com.aloysius.dicoding.DataDummy
import com.aloysius.dicoding.MainDispatcherRule
...
import com.aloysius.dicoding.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyPagingRepository.getStory()).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(userRepository, storyPagingRepository)
